...
import 'package:himatubu_chat/services/cache_service.dart';
  ...
  Widget build(BuildContext context) {
    return CachedNetworkImage(
      ...
      placeholder: (context, url) => CircleAvatar(
        radius: radius,
        backgroundImage: const AssetImage('assets/images/core/loading.gif'),
      ),
      errorWidget: (context, url, error) => CircleAvatar(
          radius: radius,
          backgroundImage:
              const AssetImage('assets/images/core/no_internet.jpg')),
    );
  }
}
